...
{
    public partial class InitilizeDataBaseMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exercise_Theme_ThemeId",
                        column: x => x.ThemeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourseExercise", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentCourseExercise_Exercise_ExerciseId",
                        column: x => x.ExerciseId,
                        principalTable: "Exercise",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentCourseExercise_StudentCourse_StudentCourseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseExercise_ExerciseId",
                table: "StudentCourseExercise",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseExercise_StudentCourseId",
                table: "StudentCourseExercise",
